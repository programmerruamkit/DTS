<?php 
    ...
    $_SESSION['SIDEBAR']='รายงานสมุดคุมเลขที่วางบิลประจำเดือน.html';
    $_SESSION['DROPDOWN']='9';
                    ...
                    <div class="grow">
                        <div class="flex flex-wrap justify-left gap-2">
                            <div class="flex items-center gap-2">
                                <h5 class="text-16">รายงานสมุดคุมเลขที่วางบิลประจำเดือน</h5>
                            </div> 
                        </div>
                    </div>
                </div>
...
<!-- Overlay -->
<div id="overlay" class="overlay" onclick="closeModal_report_mbc()"></div>
<!-- Modal -->
<div id="monthYearModal" class="modal fixed inset-0 hidden bg-gray-900 bg-opacity-50 flex justify-center items-center">
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
        <div class="flex items-center justify-between p-4 border-b dark:border-zink-300/20">
            <h5 class="text-16">รายงานสมุดคุมเลขที่วางบิลของ <span id='comcode1'></span></h5>
            <button aria-label="button" onclick="closeModal_report_mbc()" data-modal-close="billingModal" class="transition-all duration-200 ease-linear text-slate-400 hover:text-red-500"><i data-lucide="x" class="size-5"></i></button>
        </div>
